...
#  export PYSP_TEST_spark_sql_adaptive_enabled=true
  export PYSP_TEST_spark_eventLog_enabled=true
  export PYSP_TEST_spark_eventLog_dir=${WORKSPACE}/eventlog
mkdir -p ${WORKSPACE}/eventlog
...
###
###    URM_URL=https://artifactory.nvidia.com/artifactory/sw-spark-test-maven HOST_NAME=artifactory.nvidia.com \
###    $SPARK_HOME/bin/spark-submit \
###     --conf spark.eventLog.enabled=true \
###     --conf spark.eventLog.dir=${WORKSPACE}/eventlog \
###     --conf spark.jars.ivySettings=${WORKSPACE}/jenkins/ivysettings.xml \
###     --packages com.nvidia:test:0.3.0,com.nvidia:rapids-4-spark_2.12:24.02.0 \
###     --class org.apache.spark.examples.SparkPi \
###     $SPARK_HOME/examples/jars/spark-examples_2.12-${SPARK_VER}.jar
  fi
find ~/.ivy2/ -name "*.jar" || true
