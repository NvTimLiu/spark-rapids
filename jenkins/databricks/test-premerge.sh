...
cd spark-rapids
          ls -l /dbfs/FileStore/tim
RAPIDS_JAR=/dbfs/FileStore/tim/$RAPIDS_BUILT_JAR
CUDF_JAR=/dbfs/FileStore/tim/cudf-${CUDF_VERSION}-${CUDA_CLASSIFIER}.jar
...
$SPARK_HOME/bin/spark-submit ./runtests.py src/main/python/join_test.py --runtime_env="databricks"
