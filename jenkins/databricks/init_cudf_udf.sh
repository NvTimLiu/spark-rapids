...
# The init script to set up environment for the cudf_udf tests on Databrcks
# This file will be auto pushed into the dbfs:/databricks/init_scripts once it is updated.
