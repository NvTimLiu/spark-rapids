...
#
# Compared to run_it.sh leveraging Jenkins parallel jobs to run pytests,
# This file parallely runs pytests with python-xdist(e.g., TEST_PARALLEL=4) instead.
set -ex
...
source $db_script_path/common-vars.sh
