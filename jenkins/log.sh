...
ls -l surefire-reports || true
echo surefire-reports-1-BUILD_NUMBER: surefire-reports-$1-$BUILD_NUMBER
tar -cvf surefire-reports-$1-$BUILD_NUMBER.tar surefire-reports

/usr/bin/expect <<-EOF
set time 30
spawn scp surefire-reports-$1-$BUILD_NUMBER.tar timl@10.19.183.187:/home/timl/blossom
