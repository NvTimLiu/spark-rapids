...
if [[ $SCALA_BINARY_VER == "2.13" ]]; then
    set_env_var_SPARK_SHIM_VERSIONS_ARR -PpremergeUT1Scala213
    SPARK_SHIM_VERSIONS_PREMERGE_UT_1=("${SPARK_SHIM_VERSIONS_ARR[@]}")
    set_env_var_SPARK_SHIM_VERSIONS_ARR -PpremergeUT2Scala213
    SPARK_SHIM_VERSIONS_PREMERGE_UT_2=("${SPARK_SHIM_VERSIONS_ARR[@]}")
    # utf-8 cases
    set_env_var_SPARK_SHIM_VERSIONS_ARR -PpremergeUTF8Scala213
...
if [ $SCALA_BINARY_VER == "2.13" ]; then
SPARK_SHIM_VERSIONS_DATABRICKS=()
SPARK_SHIM_VERSIONS_SNAPSHOTS=(330)
SPARK_SHIM_VERSIONS_SNAPSHOTS_TAIL=()
SPARK_SHIM_VERSIONS_NOSNAPSHOTS=(330)
SPARK_SHIM_VERSIONS_NOSNAPSHOTS_TAIL=()
SPARK_SHIM_VERSIONS_SNAPSHOTSONLY=()
SPARK_SHIM_VERSIONS_PREMERGE_UT_1=(340)
SPARK_SHIM_VERSIONS_PREMERGE_UT_2=(350)
SPARK_SHIM_VERSIONS_PREMERGE_UTF8=(340)
else
SPARK_SHIM_VERSIONS_SNAPSHOTS=(311)
SPARK_SHIM_VERSIONS_SNAPSHOTS_TAIL=()
SPARK_SHIM_VERSIONS_NOSNAPSHOTS=(311)
SPARK_SHIM_VERSIONS_NOSNAPSHOTS_TAIL=()
SPARK_SHIM_VERSIONS_SNAPSHOTSONLY=()
SPARK_SHIM_VERSIONS_PREMERGE_UT_1=(320)
SPARK_SHIM_VERSIONS_PREMERGE_UT_2=(330)
SPARK_SHIM_VERSIONS_PREMERGE_UTF8=(340)
fi
...
echo "SPARK_SHIM_VERSIONS_SNAPSHOTSONLY=${SPARK_SHIM_VERSIONS_SNAPSHOTSONLY[@]}"
echo "SPARK_SHIM_VERSIONS_PREMERGE_UT_1=${SPARK_SHIM_VERSIONS_PREMERGE_UT_1[@]}"
echo "SPARK_SHIM_VERSIONS_PREMERGE_UT_2=${SPARK_SHIM_VERSIONS_PREMERGE_UT_2[@]}"
echo "SPARK_SHIM_VERSIONS_PREMERGE_UTF8=${SPARK_SHIM_VERSIONS_PREMERGE_UTF8[@]}"
